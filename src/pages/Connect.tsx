...
export default function Connect() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] p-4 space-y-4">
      ...
      <section className="overflow-hidden rounded-2xl border border-violet-400/25 bg-gradient-to-br from-violet-500/[.13] to-cyan-500/[.06]">
        <button onClick={() => setShowIntelligence(!showIntelligence)} className="flex w-full items-center gap-3 p-4 text-left">
          <div className="rounded-xl border border-violet-300/25 bg-violet-400/10 p-2"><BrainCircuit className="h-5 w-5 text-violet-200" /></div>
        ...
        {showIntelligence && (
          <div className="space-y-4 border-t border-white/10 p-4">
            ...
            <div className="border-t border-white/10 pt-4"><p className="mb-3 text-xs font-bold uppercase tracking-wider text-violet-100">Tell Neuro Network about yourself</p>
